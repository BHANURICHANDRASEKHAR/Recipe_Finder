...
import {  successfunction } from '../../toaster';
export default function Images({data,languageData}) {
  return (
    <div className='row mt-3'>
              <div className='col-sm-6'>
                <div className='card mt-2'>
                  <img className='card-img-top recipe-img' src={data.img}  alt='img not found' /><FaHeart className='savebutton' onClick={()=>{successfunction()}}/>
                </div>
              </div>
